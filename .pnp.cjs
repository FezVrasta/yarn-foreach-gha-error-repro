...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "pkg_a",
        "reference": "workspace:pkg_a"
      },
      {
        "name": "pkg_b",
        "reference": "workspace:pkg_b"
      }
    ],
    ...
    "fallbackExclusionList": [
      ...
      ["yarn-foreach-gha-error-repro", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
